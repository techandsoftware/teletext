...
export class Cell {
    ...
    setSpace_(heldMosaic) {
        if ((this._type == CellType.MOSAIC_CONTIGUOUS_ || this._type == CellType.MOSAIC_SEPARATED_)
            ...
            if (this._type == CellType.MOSAIC_SEPARATED_) charEncoding = 'g1_block_mosaic_to_unicode__legacy_computing_separated';
...
function getCharForGraphic(type, byte) {
    switch (type) {
        ...
        case CellType.MOSAIC_SEPARATED_:
            return getCharWithEncoding(byte, 'g1_block_mosaic_to_unicode__legacy_computing_separated');
        case CellType.G3_:
