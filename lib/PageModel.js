...
export class PageModel {
    ...
    notify_() {
        ...
        this._screen.forEach((row) => {
            row.forEach((cell) => cell.resetDirty_());
        });
    }
    ...
    getRow_(rowNum) {
        ...
        this._screen[rowNum].forEach((cell, cellIndex) => { // TODO refactor
        ...
        // if (rowNum == 24) this.printDirtyGrid();
